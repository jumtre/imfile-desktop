export default {
  ...
  'task-uri': 'Download URL',
  'update-link': 'Update Link',
  'update-link-title': 'Update Download Link',
  'update-link-hint': 'When a link expires, paste a new one to continue downloading. Existing progress is kept.',
